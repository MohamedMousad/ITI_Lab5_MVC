...
namespace EmployeeSystem.BLL.Service.Implementation
{
    public class EmployeeService : IEmployeeService
    {
        ...
        private readonly IDepartmentService departmentService; // Add this line

        public EmployeeService(IEmployeeRepo employeeRepo, IDepartmentService departmentService) // Modify constructor
        {
